...
<title>UM2 · Student Information System</title>
<link rel="icon" type="image/png" sizes="32x32"
href="https://raw.githubusercontent.com/um2iucoffice/um2portal/3890864b9ebf4452402080f8356786aa8767dc2b/public/favicon.png?v=2">
...
<div id="loginScreen">
  <div class="login-left">
    <div class="login-crest">
      ...
      <div class="login-institution">UM2-IUC</div>
      <div class="login-tagline">Student<br>Information System</div>
    </div>
  ...
  <div class="login-right">
    <div class="login-form-wrap">
      ...
      <h2>Welcome to UM2 Student Hub!</h2>
      <p>Use your Student ID and assigned password.</p>
      <div class="field">
        <label>Student ID</label>
        <input type="text" id="loginStudentId" placeholder="e.g. iuc125001" autocomplete="username">
      </div>
      <div class="field">
...
<div id="dashboard">
  ...
  <div class="header">
    <div class="header-inner">
      <div class="h-brand">
        ...
        <span class="h-name">Student Information System</span>
      </div>
  ...
  <div class="nav">
    <div class="nav-inner">
      <button class="ntab active" data-tab="home" onclick="switchTab('home',this)">Home</button>
      <button class="ntab" data-tab="profile" onclick="switchTab('profile',this)">My Profile</button>
      <button class="ntab" data-tab="grades" onclick="switchTab('grades',this)">Academic Results</button>
      <button class="ntab" data-tab="docs" onclick="switchTab('docs',this)">Documents</button>
      <button class="ntab" data-tab="idcard" id="navIdCard" onclick="switchTab('idcard',this)">ID Card</button>
      <button class="ntab" data-tab="photo" onclick="switchTab('photo',this)">Photo</button>
  ...
  <div class="main">
    ...
    <div class="panel active" id="panel-home">
      ...
      <div class="home-hero">
        ...
        <div class="home-hero-text">
          ...
          <div class="home-hero-sub">Academic Year 2026–2027 &nbsp;·&nbsp; UM2 Student Information System</div>
        </div>
      ...
      <div class="qlinks">
        ...
        <div class="ql" onclick="switchTab('grades')">
          ...
          <div class="ql-t">Academic Results</div>
    ...
    <div class="panel" id="panel-profile">
      <div class="ph"><h2>My Profile</h2><p>Personal &amp; enrollment information</p></div>
      <div class="banner">
      ...
      <div class="icard">
        ...
        <div class="igrid">
          ...
          <div class="icell"><div class="ic-lbl">Graduation Status</div><div class="ic-val" id="infoGrad">—</div></div>
        ...
        <div class="idcard">
          ...
          <div class="idcard-back">
            ...
            <div class="idcard-notice">
              This card is the property of UM2IUC. If found, please return to the Secretariat Office. Misuse is subject to disciplinary action.
            </div>
          </div>
        </div>
      ...
      <div style="max-width:560px">
        ...
        <div class="icard" style="margin-bottom:16px">
          ...
          <div style="padding:28px 24px;display:flex;align-items:center;gap:28px;flex-wrap:wrap">
            <div id="profilePhotoPreview" style="width:100px;height:120px;border-radius:10px;background:var(--surface);border:1.5px solid var(--line);overflow:hidden;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:36px;color:var(--ink3)">📷</div>
            <div>
              <div style="font-size:14px;font-weight:600;color:var(--ink);margin-bottom:4px" id="photoPreviewName">—</div>
              <div style="font-size:12px;color:var(--ink3)" id="photoPreviewId">—</div>
...
function normaliseGradeRow(raw) {
  ...
  return {
    ...
    grade: firstValue(g, ['grade', 'Grade', 'letter_grade', 'LetterGrade']),
...
function populateIDCard(s, isGraduated, gradID, gradDate) {
  const init = (s.fullName || '').split(' ').map(w => w[0]).join('').toUpperCase().slice(0,2) || '?';
  document.getElementById('idcardPhoto').textContent    = init;
...
function printIDCard() {
  ...
  <div class="idcard">
    <div class="idcard-front">
      ...
      <div class="idcard-divider-line"></div>
      <div class="idcard-body">
        <div class="idcard-photo">${esc(s.init)}</div>
        <div class="idcard-info">
    ...
    <div class="idcard-back">
      ...
      <div class="idcard-notice">This card is the property of UM2IUC. If found, please return to the Secretariat Office. Misuse is subject to disciplinary action.</div>
    </div>
  </div>
  <script>
...
function renderGrades(grades, student) {
  ...
  const groups = {};
  grades.forEach(g => {
    const course = COURSES[g.courseId] || { name: g.courseId, year: 'Other', block: 'MBBS Program', credits: 'TBD', assessment: '—' };
  ...
  const preferredOrder = ['Foundation Year', 'M-1', 'M-2', 'M-3', 'M-4', 'M-5'];
  const order = [
  ...
  if (summaryEl) {
    ...
    document.getElementById('tsCredits').textContent = 'TBD';
  ...
  order.forEach(yr => {
    ...
    html += `<div class="g-year-head">${escHtml(yr)} &nbsp;·&nbsp; MBBS Program</div>`;
    ...
    Object.entries(blockMap).forEach(([blockName, rows]) => {
      ...
      rows.forEach(r => {
        ...
        html += `<tr>
          ...
          <td style="text-align:center"><span class="gt-cr">TBD</span></td>
...
function switchTab(id, btn) {
  ...
  if (btn) {
    ...
    document.querySelectorAll('.ntab').forEach(b => { if (b.dataset.tab === id) b.classList.add('active'); });
  }
}
...
function printDocument(type) {
  ...
  const status    = document.getElementById('infoStatus').textContent || '—';
  const enroll    = document.getElementById('infoEnroll').textContent || '—';
  const grad      = document.getElementById('infoGrad').textContent || '—';
  const gradID    = document.getElementById('infoGradID')?.textContent || '';
  const gradDate  = document.getElementById('infoGradDate')?.textContent || '';
  const isGraduated = /^graduated$/i.test(grad.trim());
  const idLabel   = isGraduated ? 'Alumni ID' : 'Student ID';
  ...
  function yearTable(group) {
    ...
    group.rows.forEach((r, i) => {
      ...
      rows += `<tr>
        ...
        <td style="${TD}${bg}text-align:center">TBD</td>
...
const confirmationBody = type === 'confirmation' ? `
  ...
  ">
    ...
    <p style="text-align:justify;">
      ...
      and has been conferred the degree with a graduation status of
    ...
    <br>
    <p style="text-align:justify;">
      The student was admitted in <strong>${admission}</strong> and is
      currently in <strong>${status}</strong> status with an enrollment
      status of <strong>${enroll}</strong>.
    </p>
    `}
    <br>
    <p>
...
<body>
  ...
  <table>
    ...
    <tbody><tr><td style="position:relative;z-index:1">
      ...
      <div class="inst-hdr">
        ...
        <div>
          ...
          <div class="doc-meta">
            ...
            ${isGraduated ? 'Graduation Status: ' + grad : 'Enrollment: ' + enroll}
      ...
      <div class="transcript-student-section" style="grid-template-columns:1.2fr 1.2fr .8fr ${isGraduated && gradID ? '.8fr' : ''}">
      ...
      <div class="transcript-student-section" style="grid-template-columns:1fr 1fr">
        <div class="transcript-student-item">
          <div class="transcript-student-label">Graduation Status</div>
...
function previewPhoto(input) {
  ...
  reader.onload = function(e) {
    ...
    if (size)  size.textContent = (file.size / 1024).toFixed(0) + ' KB · ' + file.type.replace('image/', '').toUpperCase();
